...
map ,<g> 
map ,<h> :e %:p:s,.h$,.X123X,:s,.cpp$,.h,:s,.X123X$,.cpp,
nnoremap ,  :nohlsearch
nnoremap ,a :Ag
...
set ruler
set runtimepath=~/.vim,~/.vim/bundle/Vundle.vim,~/.vim/bundle/gundo.vim,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim74,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/after,~/.vim/bundle/Vundle.vim,~/.vim/bundle/Vundle.vim/after,~/.vim/bundle/gundo.vim/after
set showcmd
set showmatch
set softtabstop=4
...
silent only
cd ~/Documents/School/McGill\ U3/ECSE_420
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +16 Parallel-Sudoku-Solver/puzzle_solver/sudoku_solver.c
args Parallel-Sudoku-Solver/
edit Parallel-Sudoku-Solver
...
exe 'vert 1resize ' . ((&columns * 17 + 72) / 144)
exe 'vert 2resize ' . ((&columns * 126 + 72) / 144)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
12
normal! 0
lcd ~/Documents/School/McGill\ U3/ECSE_420
wincmd w
argglobal
edit ~/Documents/School/McGill\ U3/ECSE_420/Parallel-Sudoku-Solver
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <S-Up> :Pexplore
inoremap <buffer> <silent> <S-Down> :Nexplore
